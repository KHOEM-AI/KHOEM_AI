...
#
# ⚠️ សុវត្ថិភាព៖ កុំដាក់តម្លៃ key ពិតចូលក្នុងអត្ថបទ log/warning ណាមួយឡើយ —
# គ្រាន់តែប្រាប់ថា "កំណត់ឬអត់" គ្រប់គ្រាន់ហើយ។ បើ key ធ្លាប់លេចធ្លាយ (ឧ. ក្នុង
# chat, screenshot, git commit) ត្រូវប្តូរ key ថ្មីភ្លាមៗ។
# ==============================================================================
